...
//               warning = ""/>
// </div>
function InputBoxWithIcon({title, placeholder, type, width, warning, icon}) {
  return (
    <div>
      ...
      <label class="relative block">
          ...
          <input
            ...
            type={type}
            className={`peer ${width} h-12 mt-1 block px-3 py-2 pl-10 bg-white border border-slate-300 rounded-md text-base shadow-sm
